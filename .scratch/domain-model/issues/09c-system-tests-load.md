...
- [x] Test: **Concurrent Order Placement (No Oversell)**
...
- [x] Test: **Concurrent Reservation + Payment Capture**
...
- [x] Test: **Scheduler Contention (Multiple Inventory Instances)**
...
- [x] Add load test utilities to `system-test`: parallel executor, metrics collector, assertion helpers
- [x] Document: how to run load tests locally (resource requirements), CI integration (nightly)
