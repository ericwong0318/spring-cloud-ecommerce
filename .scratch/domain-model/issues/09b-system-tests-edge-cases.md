...
- [ ] Test: **Partial Reservation + Backorder**
...
- [ ] Test: **Reservation Expiry (15 min)**
...
- [ ] Test: **Payment Failure → Order Cancel → Inventory Release**
  - Place Order → reservation created
...
- [ ] Test: **Partial Capture → Partial Confirm**
...
- [ ] Test: **Notification Retry + Fallback**
...
- [ ] Test: **Variant Soft-Delete with Existing OrderItems**
